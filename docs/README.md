...
A: Transfer the text file named "Tasks.txt", located in the same directory as your CS2113T_iP file, over to your other computer. Place it in the same directory as the CS2113T_iP file on your other computer. Your tasks will then be loaded from this text file when you run iP.jar on your new computer.
